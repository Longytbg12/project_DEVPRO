  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 header-search"> 
      ...
      <div style="margin-top:25px;">
        <input type="text" autocomplete="off" value="" placeholder="Nhập từ khóa tìm kiếm..." id="key" class="input-control">
        <button style="margin-top:5px;" type="submit"> <i class="fa fa-search" id="btnSearch"></i> </button>
        <div class="smart-search">
          <ul>
            <li><img src="http://localhost:8080/devpro/php57/project/assets/upload/products/1633960444_1629293223_132195020732826532_8.jpg"> <a href="#">Sản phẩm 1</a></li>
            <li><img src="http://localhost:8080/devpro/php57/project/assets/upload/products/1633960444_1629293223_132195020732826532_8.jpg"> <a href="#">Sản phẩm 1</a></li>
            <li><img src="http://localhost:8080/devpro/php57/project/assets/upload/products/1633960444_1629293223_132195020732826532_8.jpg"> <a href="#">Sản phẩm 1</a></li>
          </ul>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
      <div class="wrapper-mini-cart"> <span class="icon"><i class="fa fa-shopping-cart"></i></span> <a href="cart"> <span class="mini-cart-count"> <?php echo $ProductNumberCart; ?> </span> sản phẩm <i class="fa fa-caret-down"></i></a>
